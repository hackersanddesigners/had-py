...
class had(object):
  ...
  def on_article(self, request, page_title=None, section_title=None, wk_nav_main=nav_main(), wk_nav_sections=nav_sections()):
    ...
    for list in soup_bodytext.find_all(['ul', 'ol']):
      list['class'] = 'pd-h--2 pd-b--1'
    ...
    for gallery_item in soup_bodytext.find_all('li', class_="gallerybox"):
      ...
      gallery_item_caption['class'] = 'pd-t--2 ft-sans'
    ...
    for gallery in soup_bodytext.find_all('ul', class_="gallery"):
      gallery.name = 'div'
      gallery['data-flickity'] = '{  "adaptiveHeight": false, "cellAlign": "center", "contain": false, "friction": "0.35", "lazyLoad": true, "percentPosition": false, "resize": true, "wrapAround": true }'
